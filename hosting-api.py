...
def record_del(arguments):
    ...
    # get matching record(s):
    recorddata = json.loads(record_get(Namespace(func=arguments.func,domain='',id=arguments.id,name=arguments.name,type=arguments.type,content=arguments.content)))
